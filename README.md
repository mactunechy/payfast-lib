...
- IPN (Instant Payment Notification) Support: Receive and process IPN callbacks from PayFast for handling payment updates.
...
_**Please note that this README is a work in progress and will be updated with detailed information, examples, and usage instructions in the coming days.**_
